...
#ifndef CPW_FACTORY_INVENTORIESHANDLER_H
#define CPW_FACTORY_INVENTORIESHANDLER_H
 ...
 * @todo write docs
 */
class InventoriesHandler :  CPW::QueryActions,   CPW::Factory::RootHandler
{
public:
    /**
     * Default constructor
...
#endif // CPW_FACTORY_INVENTORIESHANDLER_H
