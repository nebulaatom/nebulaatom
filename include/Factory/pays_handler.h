...
#ifndef CPW_FACTORY_PAYSHANDLER_H
#define CPW_FACTORY_PAYSHANDLER_H
...
class PaysHandler :  public CPW::QueryActions,   CPW::Factory::RootHandler
{
	public:
		PaysHandler();
		~PaysHandler();
...
#endif // CPW_FACTORY_PAYSHANDLER_H
