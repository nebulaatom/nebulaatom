...
#ifndef CPW_FACTORY_INVOICESHANDLER_H
#define CPW_FACTORY_INVOICESHANDLER_H
 ...
 * @todo write docs
 */
class InvoicesHandler :  CPW::QueryActions,   CPW::Factory::RootHandler
{
public:
    /**
     * @todo write docs
...
#endif // CPW_FACTORY_INVOICESHANDLER_H
